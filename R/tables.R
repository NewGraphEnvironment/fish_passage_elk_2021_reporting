...
# We need to update our column names according to the new output from bcfishpass.crossings
# this is how we are going to do that

bcfishpass_names_updated <- names(bcfishpass) %>%
  tibble::as_tibble() %>%
...
xref_bcfishpass_names <- tibble::tribble(
                                                      ...
                                                      "modelled_crossing_type_source",                          "Modelled Crossing Type Source",       NA,       NA,
                                                                     "barrier_status",                                         "Barrier Status",       NA,       NA,
                                                                    "pscis_road_name",                                        "PSCIS Road Name",       NA,       NA,
                                                                  "pscis_stream_name",                                      "PSCIS Stream Name",       NA,       NA,
                                                           "pscis_assessment_comment",                               "PSCIS Assessment Comment",       NA,       NA,
                                                   "transport_line_structured_name_1",                       "Transport Line Structured Name 1",       NA,       NA,
                                                    "transport_line_type_description",                        "Transport Line Type Description",       NA,       NA,
                                                 "transport_line_surface_description",                     "Transport Line Surface Description",       NA,       NA,
                                                                "ften_forest_file_id",                                    "Ften Forest File Id",       NA,       NA,
                                                        ...
                                                        "ften_life_cycle_status_code",                            "Ften Life Cycle Status Code",       NA,       NA,
                                                         ...
                                                         "rail_operator_english_name",                             "Rail Operator English Name",       NA,       NA,
                                                           ...
                                                           "downstream_route_measure",                               "Downstream Route Measure",       NA,       NA,
                                                                    ...
                                                                    "localcode_ltree",                                        "Localcode Ltree",       NA,       NA,
                                                               "watershed_group_code",                                   "Watershed Group Code",       NA,       NA,
                                                                   "gnis_stream_name",                                       "Gnis Stream Name",       NA,       NA,
                                                                    "dnstr_crossings",                                        "Dnstr Crossings",       NA,       NA,
                                                       "dnstr_barriers_anthropogenic",                           "Dnstr Barriers Anthropogenic",       NA,       NA,
                                                       "upstr_barriers_anthropogenic",                           "Upstr Barriers Anthropogenic",       NA,       NA,
                                                 "dnstr_barriers_anthropogenic_count",                     "Dnstr Barriers Anthropogenic Count",       NA,       NA,
                                                                       "stream_order",                                           "Stream Order",       NA,       NA,
                                                                   "stream_magnitude",                                       "Stream Magnitude",       NA,       NA,
                                                                           "gradient",                                               "Gradient",       NA,       NA,
                           ...
                           "steelhead_belowupstrbarriers_slopeclass03_waterbodies_km", "Steelhead Below Barriers Slopeclass03 Waterbodies (km)",       NA,       NA,
                                 ...
                                 "wct_belowupstrbarriers_slopeclass03_waterbodies_km",       "WCT Below Barriers Slopeclass03 Waterbodies (km)",     130L,       2L,
                                             ...
                                             "wct_belowupstrbarriers_slopeclass30_km",                   "WCT Below Barriers Slopeclass30 (km)",     190L,       2L,
                                                  ...
                                                  "st_spawning_belowupstrbarriers_km",                        "ST Spawning Below Barriers (km)",       NA,       NA,
                                                   "st_rearing_belowupstrbarriers_km",                         "ST Rearing Below Barriers (km)",       NA,       NA,
                                                                    "wct_spawning_km",                                      "WCT Spawning (km)",       NA,       NA,
                                                                     "wct_rearing_km",                                       "WCT Rearing (km)",       NA,       NA,
                                                 "wct_spawning_belowupstrbarriers_km",                       "WCT Spawning Below Barriers (km)",       NA,       NA,
                                                  "wct_rearing_belowupstrbarriers_km",                        "WCT Rearing Below Barriers (km)",       NA,       NA,
                                                                    "all_spawning_km",                                      "All Spawning (km)",       NA,       NA,
                                                 "all_spawning_belowupstrbarriers_km",                       "All Spawning Below Barriers (km)",       NA,       NA,
                                                                     "all_rearing_km",                                       "All Rearing (km)",       NA,       NA,
                                                  "all_rearing_belowupstrbarriers_km",                        "All Rearing Below Barriers (km)",       NA,       NA,
                                                             "all_spawningrearing_km",                              "All Spawning Rearing (km)",       NA,       NA,
                                          "all_spawningrearing_belowupstrbarriers_km",               "All Spawning Rearing Below Barriers (km)",       NA,       NA,
                                                                   "dbm_mof_50k_grid",                                       "Dbm Mof 50k Grid",       NA,       NA,
                                                     "wct_betweenbarriers_network_km",                      "WCT Between Barriers Network (km)",     200L,       1L,
                                                    "wct_spawning_betweenbarriers_km",                     "WCT Spawning Between Barriers (km)",     210L,       1L,
                                                     "wct_rearing_betweenbarriers_km",                      "WCT Rearing Between Barriers (km)",     210L,       2L,
                                             "wct_spawningrearing_betweenbarriers_km",             "WCT Spawning Rearing Between Barriers (km)",     200L,       2L,
                                                    "all_spawningrearing_per_barrier",                       "All Spawning Rearing Per Barrier",       NA,       NA
                           )
...
##add the priority info
tab_cost_est_phase2_report_prep <- tab_cost_est_prep5 %>%
...
tab_cost_est_phase2_report <- tab_cost_est_phase2_report_prep %>%
  filter(source %like% 'phase2') %>%
...
rm(tab_cost_est_prep, tab_cost_est_prep2,
   tab_cost_est_prep3, tab_cost_est_prep4, tab_cost_est_prep5, tab_cost_est_phase2_report_prep)
